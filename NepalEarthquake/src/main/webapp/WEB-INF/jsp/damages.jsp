...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/damages.css" />
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.0/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    <script src="/resources/js/heatmap.js" type="text/javascript"> </script>
...
<div class="container-fluid">
    ...
    <br>
            ...
            <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCFc7pJusrQeKWR-7FpNZUQEa4GUDadyi8&callback=initMap1"></script>
